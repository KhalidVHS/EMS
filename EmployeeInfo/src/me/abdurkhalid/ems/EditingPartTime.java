 ...
 * @author 568789
 */
public class EditingPartTime extends javax.swing.JFrame {
    static EmployeeInfo theEmployee;
    /**
     * Creates new form EditingEmployee
     */
    public EditingPartTime(EmployeeInfo employee) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Employee PartTime");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditingPartTime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditingPartTime(theEmployee).setVisible(true);
            }
        });
    }
